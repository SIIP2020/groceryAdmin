				                                       ...
				                                       while ($row = mysqli_fetch_assoc($result)) {
				                                        ...
				                                        echo '<tbody>
				                                            		<tr>                                               
																		...
																		<td>'.$row['cat_name'].'</td>														
																		<td><span class="badge-item badge-status">'.$row['status'].'</span></td>
																		<td class="action-btns">
																			<a href="edit_category.php?cat_id='.base64_encode($row["cat_id"]).'" class="edit-btn"><i class="fas fa-edit"></i> Edit</a>
																       <a href="includes/delete_cat.php?cat_id='.base64_encode($row["cat_id"]).'&action=delete" class="delete-btn" title="delete"><i class="fas fa-trash-alt"></i></a>
