												...
												<tbody>
													<tr>
														...
														<td class="action-btns">
															<a href="customer_edit.php?uid=<?php echo base64_encode($row['uid']); ?>" class="edit-btn" title="Edit"><i class="fas fa-edit"></i></a>
															<a href="includes/delete_cust.php?uid=<?php echo base64_encode($row['uid']); ?>&action=delete " class="delete-btn" title="Edit"><i class="fas fa-trash-alt"></i></a>
														</td>
													</tr>
												</tbody>
												<?php
