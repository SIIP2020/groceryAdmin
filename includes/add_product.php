...
//empty fields check
    ...
    { 
         ...
         // Check extension
    			...
    			$sql = "INSERT INTO product(Pname, cat_id, MRP, Discount_mrp, quantity, Descp, image) VALUES(?,?,?,?,?,?,?)";
    			$stmt = mysqli_stmt_init($conn);
                 ...
                 exit(); 	
    	        	...
    	        	mysqli_stmt_bind_param($stmt,"siiisss", $name, $catid, $mrp, $disc_mrp, $quantity, $desc, $fname);
