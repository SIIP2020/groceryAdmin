									...
									<div class="card-body-table">
										<div class="table-responsive">
											<table class="table ucp-table table-hover">
												...
												<?php	$sql = "SELECT * FROM shopreq Where verified='verified'";
												...
												<tbody>
													<tr>
														...
														<?php echo '<td class="action-btns1">
															<div class="col-lg-12">
																<a href="includes/approve_req.php?reqid='.base64_encode($row['req_id']).'&action=delete" class="add-btn hover-btn">Change </a>
															</div>
															'
												?>
														</td>
